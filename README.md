...
### 🛠️ Featured project — [CanniScope](https://github.com/IgorOdaryuk/Canniscope)

A free, browser-based tool that reads your **Google Search Console** export and finds where your pages are **cannibalizing each other** for the same local query — then tells you what to merge, redirect, or leave alone.
🔗 **Live:** [canniscope.vercel.app](https://canniscope.vercel.app)
